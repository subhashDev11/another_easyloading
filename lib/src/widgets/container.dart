import 'dart:async';
import 'package:another_easyloading/src/enums.dart';
import 'package:another_easyloading/src/loading_container.dart';
import 'package:another_easyloading/src/theme.dart';
...
class LoadingContainerState extends State<LoadingContainer>
  ...
  void _onTap() async {
    if (_dismissOnTap) await AnotherEasyLoading.dismiss();
  }
